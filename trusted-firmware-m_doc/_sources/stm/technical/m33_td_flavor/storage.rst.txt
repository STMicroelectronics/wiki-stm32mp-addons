...
ITS is stored on backup SRAM. This memory can be shared between Arm® Cortex®-A and Arm® Cortex®-M, the ``RISAF1`` allows to define the access right.
...
PS is stored on external SNOR and need security setup:
